...
import { usePixiStore, usePointerStore } from '../state'
...
export const PointerEvents = () => {
    ...
    const updatePinch = () => {
        ...
        if (!pointer.pinching && nTouches > 1) {
            ...
            pointer.pinchLength = p2.vec2.distance(touchA.physicsPosition, touchB.physicsPosition)
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            pixi.canvasElement.removeEventListener('wheel', wheelHandler)
        }
    }, [moveHandler, downHandler, upHandler, wheelHandler])
